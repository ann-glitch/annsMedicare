...
exports.register = (0, express_async_handler_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { name, email, password, role, gender, dateOfBirth, phoneNumber } = req.body;
    //create user
    const user = yield User_1.default.create({ name, email, password, role, gender, dateOfBirth, phoneNumber });
